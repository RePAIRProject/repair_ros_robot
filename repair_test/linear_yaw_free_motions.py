...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        la_q_1 = -np.array([1.0, 0.0, -0.5, 1.0, 2.0, 0.0, 0.0])
        la_q_2 = -np.array([1.0, 1.0, -2.1, 0.4, -0.5, 0.0, -2.7])
        la_q_3 = -np.array([0.5, 0.8, -0.7, 2.0, 0.5, 0.0, 1])
        la_q_4 = -np.array([0.5, 0.4, -1.0, 0.7, 1.8, 0.0, -2.])
